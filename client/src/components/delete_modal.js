...
class DeleteModal extends React.Component {
	...
	async deleteStudent() {
		await this.props.deleteStudent(
			this.props.delete_modal.delete_id,
			this.props.node_server,
		);
		...
		return (
			<div className="modalContainer">
				<div className="modalContent">
					...
					<button
						onClick={() => {
							this.deleteStudent(this.props.delete_id);
						}}
						type="button"
						className="btn btn-default btn-danger addButton"
					>
						{" "}
						Yes{" "}
					</button>
					<button
						...
						type="button"
						className="btn btn-default cancelButton"
					>
						{" "}
						No{" "}
					</button>
...
export default connect(
	mapStateToProps,
	{ getStudentList, toggleDeleteModal, deleteStudent, calculateAverageGrade },
)(DeleteModal);
